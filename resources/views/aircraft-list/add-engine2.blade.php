@extends('layouts.master') @section('title','Add Aircraft - Add Engine 2') @section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="/engine2/store" method="post">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="engine_name" placeholder="Enter engine_name" class="form-control"> @if($errors->has('engine_name'))
                            <div class="text-danger">
