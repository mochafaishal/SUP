@extends('layouts.master') @section('title','Edit Aircraft - Edit Engine 2') @section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong>edit Engine 2</strong>
                </div>
                <form action="/aircraft-engine2/update/{{ $aircraft->engine2->id }}" method="post">
                ...
                {{ method_field('PUT') }}
                    <div class="card-body card-block">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="engine_name" placeholder="Enter engine_name" class="form-control" value="{{ $aircraft->engine2->engine_name }}"> @if($errors->has('engine_name'))
