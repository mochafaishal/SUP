@extends('layouts.master') @section('title','Add Aircraft') @section('content')
                ...
                <form action="/aircraft-list/store" method="post">
                    ...
                    <div class="card-body card-block">
                        <div class="form-group">
                            ...
                            <input type="text" name="asset_name" placeholder="Enter Asset Name" class="form-control"> @if($errors->has('asset_name'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="equipment_type" placeholder="Enter Equipment Type" class="form-control"> @if($errors->has('equipment_type'))
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lessor" placeholder="Enter Lessor" class="form-control"> @if($errors->has('lessor'))
                            <div class="text-danger">
                                {{ $errors->first('lessor')}}
                            </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="start_date" placeholder="date" class="form-control"> @if($errors->has('start_date'))
                            <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="end_date" placeholder="date" class="form-control"> @if($errors->has('end_date'))
                            <div class="text-danger">
