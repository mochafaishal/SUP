@extends('layouts.master') @section('title','Edit Aircraft - Edit Airframe') @section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Aircraft - Edit Airframe</h4>
                </div>
                <div class="card-body card-block">

                    <form action="/aircraft-airframe/update/{{ $aircraft->airframe->id }}" method="post">
