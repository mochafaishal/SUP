@extends('layouts.master') @section('title','Edit Aircraft - Edit Landing') @section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong>Edit Landing</strong>
                </div>
                <form action="/aircraft-landing/update/{{ $aircraft->landing->id }}" method="post">
